        ...
        <div className='w-full md:w-1/2 flex justify-center items-center'>
          <div className='w-96 md:w-3/4 lg:w-fit mx-auto flex flex-col justify-center'>
            <div className='flex flex-col mb-6'>
              <span className='font-Fontspring text-[85px] md:text-[85px] lg:text-[100px] leading-none'>aspire</span>
              <span className='font-Fontspring text-[85px] md:text-[85px] lg:text-[100px] leading-none'>connect</span>
              <span className='font-Fontspring text-[85px] md:text-[85px] lg:text-[100px] leading-none'>succeed</span>
            </div>
...
const Section2 = () => {
  return (
    <div className='my-[120px] flex flex-col gap-[160px] 2xl:px-32 lg:px-16 px-6'>
      <div className='mx-auto lg:w-1/2'>
        <h1 className='text-6xl 2xl:text-[80px] text-center font-bold mb-6 textGradient1'>
          Explore the <br /> Newest Pathways
        </h1>
        <p className='text-secondary text-center text-md font-Inter'>
      ...
      <div className='flex gap-6'>
        ...
        <div className='w-full text-center lg:text-left lg:w-2/3 pt-16'>
          <h1 className='text-6xl 2xl:text-[80px] font-bold textGradient1 mb-6'>Unveiling Student Internship Opportunities</h1>
          <p className='text-md text-secondary font-Inter'>
      ...
      <div className='flex flex-row-reverse gap-6'>
        ...
        <div className='w-full text-center lg:text-left lg:w-2/3 pt-16'>
          <h1 className='text-6xl 2xl:text-[80px] font-bold textGradient1 mb-6'>A Vast Network of Company Collaborations</h1>
          <p className='text-md text-secondary font-Inter'>
  ...
  return (
    <div className='py-24 2xl:px-32 lg:px-16 px-6 flex justify-center items-center gap-6 bg-primary text-secondary-200'>
      ...
      <div className='w-full text-center lg:text-left lg:w-2/3 py-6'>
        <h1 className='text-5xl lg:text-6xl 2xl:text-7xl font-bold textGradient3 mb-6'>Diverse Tech Fields, Limitless Possibilities</h1>
  ...
  return (
    <div className='pt-20 pb-[160px] px-6 lg:px-16 2xl:px-32'>
      <div className='w-1/2 mx-auto text-center mb-16'>
        <h1 className='text-5xl lg:text-6xl 2xl:text-7xl font-bold text-center textGradient2 mb-6'>
          Find Latest <br /> Opportunities
        </h1>
        <p className='text-secondary text-md font-Inter'>
